    ...
    <>
      ...
      <section className="bg-white py-12">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 prose prose-gray max-w-none">
          <h2 className="text-xl font-bold text-[#0F1B3D] mt-8 mb-4">Éditeur du site</h2>
          ...
          <h2 className="text-xl font-bold text-[#0F1B3D] mt-8 mb-4">Directeur de la publication</h2>
          <p className="text-gray-600 leading-relaxed mb-6">
            Le directeur de la publication est le Président de la FIF.
          </p>

          <h2 className="text-xl font-bold text-[#0F1B3D] mt-8 mb-4">Hébergement</h2>
          <p className="text-gray-600 leading-relaxed mb-6">
            Ce site est hébergé par <strong>Vercel Inc.</strong>, 440 N Baxter St, Coppell, TX 75019, États-Unis.
          </p>

          <h2 className="text-xl font-bold text-[#0F1B3D] mt-8 mb-4">Propriété intellectuelle</h2>
          <p className="text-gray-600 leading-relaxed mb-6">
          ...
          <h2 className="text-xl font-bold text-[#0F1B3D] mt-8 mb-4">Responsabilité</h2>
          <p className="text-gray-600 leading-relaxed mb-6">
          ...
          <h2 className="text-xl font-bold text-[#0F1B3D] mt-8 mb-4">Liens hypertextes</h2>
          <p className="text-gray-600 leading-relaxed mb-6">
          ...
          <h2 className="text-xl font-bold text-[#0F1B3D] mt-8 mb-4">Crédits</h2>
          <p className="text-gray-600 leading-relaxed mb-6">
