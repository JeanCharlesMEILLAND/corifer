...
const committees: {
...
}[] = [
  {
    ...
    members: [
      ...
      { name: 'Thales', logo: 'https://www.fif.french4dev.com/assets/adherents/thales.png' },
      { name: 'CAF', logo: 'https://www.fif.french4dev.com/assets/adherents/caf.jpg' },
      ...
      { name: 'SNCF Réseau' },
      { name: 'Keolis' },
      { name: 'FIF', logo: 'https://www.fif.french4dev.com/assets/logos/fif-logo-header.png' },
      { name: 'UTP' },
      { name: 'EPSF' },
    ],
    invites: [
      ...
      { name: 'Ferrocampus', org: 'Cluster', logo: 'https://www.fif.french4dev.com/assets/adherents/ferrocampus.jpg' },
      ...
      { name: 'ID4Mobility', org: 'Pôle', logo: 'https://www.fif.french4dev.com/assets/adherents/id4mobility.jpg' },
    ],
  },
  {
    key: 'rd',
    ...
    members: [
      ...
      { name: 'CAF', logo: 'https://www.fif.french4dev.com/assets/adherents/caf.jpg' },
      { name: 'Hitachi Rail', logo: 'https://www.fif.french4dev.com/assets/adherents/hitachi.svg' },
      { name: 'Siemens Mobility', logo: 'https://www.fif.french4dev.com/assets/adherents/siemens-mobility.jpg' },
      { name: 'ADEME' },
      { name: 'Bpifrance' },
      { name: 'DGE' },
      { name: 'DGITM' },
  ...
  },
  {
    ...
    members: [
      { name: 'FIF (RBC)', logo: 'https://www.fif.french4dev.com/assets/logos/fif-logo-header.png' },
      { name: 'AIF', logo: 'https://www.fif.french4dev.com/assets/adherents/aif.jpg' },
      { name: 'Ferrocampus', logo: 'https://www.fif.french4dev.com/assets/adherents/ferrocampus.jpg' },
      { name: 'MecateamCluster', logo: 'https://www.fif.french4dev.com/assets/adherents/mecateamcluster.jpg' },
      { name: 'TOTEM', logo: 'https://www.fif.french4dev.com/assets/adherents/cluster-totem.svg' },
      { name: 'Bpifrance' },
      { name: 'ADEME' },
      { name: 'DGE' },
      { name: 'I-Trans', logo: 'https://www.fif.french4dev.com/assets/adherents/i-trans.png' },
      { name: 'CARA', logo: 'https://www.fif.french4dev.com/assets/adherents/cara.jpg' },
      { name: 'ID4Mobility', logo: 'https://www.fif.french4dev.com/assets/adherents/id4mobility.jpg' },
    ],
  },
]
